...
(function () {
  ...
  function ensureStyle() {
    ...
    s.textContent =
      ...
      'padding:2.6vh 6vw 0;font-size:11px;letter-spacing:.32em;color:#1f6f8a;text-transform:uppercase}' +
      ...
      '#boot-overlay .bl .dim{color:#1f6f8a}#boot-overlay .bl .ok{color:#7dffb0}' +
      '#boot-overlay .bl .amber{color:#ffb648}#boot-overlay .bl .acc{color:#00acdb}' +
      ...
      '#boot-overlay .bl.pay .g{color:#1f6f8a}' +
